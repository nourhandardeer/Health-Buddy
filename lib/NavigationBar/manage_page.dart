...
class ManagePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        bool hasAppointments = appointmentDocs.isNotEmpty;
          ...
          body: hasAppointments
              ? ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var appointment = appointmentDocs[index];
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                          onPressed: () => deleteAppointment(appointmentId, context),
  ...
  static Future<void> deleteAppointment(String appointmentId, BuildContext context) async {
    try {
      ...
      if (linkedUsers.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('No linked users found for this appointment')));
        return;
      }
      ...
      await batch.commit();
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Appointment deleted for all linked users!')));
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Error: ${e.toString()}')));
    }
  }

  static void _showAppointmentDetails(BuildContext context, String doctorName,
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const AddPharmacy()));
                },
              ),
              const SizedBox(height: 16),
              TextButton(

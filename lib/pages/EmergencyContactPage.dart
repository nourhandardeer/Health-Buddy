...
//         });
//
//         print("Contact added to Firestore.");
//       } catch (e) {
...
//   void _deleteEmergencyContact(Map<String, String> contact) async {
//     final user = FirebaseAuth.instance.currentUser;
//     if (user == null) return;
//
//     try {
...
//       });
//
//       print("Contact deleted from Firestore.");
//     } catch (e) {
...
//           children: [
//             // Show add button if no contacts exist
...
//     if (user == null) return;
//
//     var contactDoc = await FirebaseFirestore.instance
//         .collection('emergencyContacts')
//         .doc(user.uid)
//         .get();
//
//     if (contactDoc.exists) {
//       linkedPatientId = contactDoc['linkedPatientId'];
//
...
//         await FirebaseFirestore.instance
//             .collection('emergencyContacts')
//             .doc(newContact["mail"]) // Using email as the document ID
//             .set({
//           ...newContact,
